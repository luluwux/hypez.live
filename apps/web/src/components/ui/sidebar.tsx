    ...
    (
        ...
        const setOpen = React.useCallback(
            (value: boolean | ((value: boolean) => boolean)) => {
                ...
                document.cookie = `${SIDEBAR_COOKIE_NAME}=${value}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}; Secure; SameSite=Strict`
            },
            [setOpenProp, open]
        )
    ...
    (
        ...
        return (
            <div
                ...
                data-side={side}
            >
                {/* Spacer Div - Forces content flow */}
                <div
                    className={cn(
                    ...
                    style={{
                        width: state === "expanded" ? "var(--sidebar-width)" : (
